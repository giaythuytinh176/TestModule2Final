    ...
    <div class="content-wrap">
        <div class="container clearfix">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                echo '<div class="alert alert-success" role="alert"> Edited Product. </div>';
                $this->redirectAfterSecondPage("", 1);
            } else {
                ?>
                <div class="row">
                    <h3>
                        <div class="col-lg-12 col-md-12">Edit Product:
                        </div>
                    </h3>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="ProductName" id="ProductName"
                                           placeholder="Product Name" value="<?php echo $data['ProductName']; ?>"
                                           required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="Quantity" id="Quantity"
                                           placeholder="Quantity" value="<?php echo $data['Quantity']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="Created" id="Created"
                                           value="<?php echo $data['Created']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
