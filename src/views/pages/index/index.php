    ...
    <table id="TestFinalTLTable" class="table table-striped table-bordered table-hover" cellspacing="0"
        ...
        <tr>
            ...
            <td>
                ...
                <a href="' . UrlControllers::url(" admin/brand/edit/" . $value['category_id']) . '"><i
                        class="fas fa-edit" title="Edit Product"></i></a>


                <a class="remove" title="Remove this item" href="#" data-toggle="modal"
                   data-target="#deleteCartModal' . $item['product_id'] . '">
                    <i class="fa fa-trash" aria-hidden="true"></i>
                </a>
                <!-- DeleteCart Modal-->
                <div class="modal fade" id="deleteCartModal' . $item['product_id'] . '" tabindex="-1" role="dialog"
                     aria-labelledby="exampleModalLabel"
                     aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="DeleteCartModal' . $item['product_id'] . '">Bạn có xoá sản
                                    phẩm này không?</h5>
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-primary" href="' . \MVC\controllers\UrlControllers::url(" shop/cart/delete/"
                                . $item['product_id']) . '">Xoá</a>
                            </div>
                        </div>
                    </div>
                </div>
